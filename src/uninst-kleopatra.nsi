...
#  RMDir "$INSTDIR\share\doc"
  ...
  DeleteRegKey SHCTX "Software\Classes\gpg4win.AssocFile.kleopatra.MIME"
  DeleteRegKey SHCTX "Software\Gpg4win\kleopatra"
  DeleteRegValue SHCTX "Software\RegisteredApplications" "Gpg4win.kleopatra"
  DeleteRegValue SHCTX "Software\Classes\.gpg\OpenWithProgids" "gpg4win.AssocFile.kleopatra.GPG"
  DeleteRegValue SHCTX "Software\Classes\.asc\OpenWithProgids" "gpg4win.AssocFile.kleopatra.ASC"
  DeleteRegValue SHCTX "Software\Classes\.pgp\OpenWithProgids" "gpg4win.AssocFile.kleopatra.PGP"
  DeleteRegValue SHCTX "Software\Classes\.pem\OpenWithProgids" "gpg4win.AssocFile.kleopatra.CMS"
  DeleteRegValue SHCTX "Software\Classes\.p7s\OpenWithProgids" "gpg4win.AssocFile.kleopatra.CMS"
  DeleteRegValue SHCTX "Software\Classes\.p7m\OpenWithProgids" "gpg4win.AssocFile.kleopatra.CMS"
  DeleteRegValue SHCTX "Software\Classes\.arl\OpenWithProgids" "gpg4win.AssocFile.kleopatra.CMS"
  DeleteRegValue SHCTX "Software\Classes\.crl\OpenWithProgids" "gpg4win.AssocFile.kleopatra.CMS"

  DeleteRegValue SHCTX "Software\Classes\.cer\OpenWithProgids" "gpg4win.AssocFile.kleopatra.X509"
  DeleteRegValue SHCTX "Software\Classes\.p12\OpenWithProgids" "gpg4win.AssocFile.kleopatra.X509"
  DeleteRegValue SHCTX "Software\Classes\.p7c\OpenWithProgids" "gpg4win.AssocFile.kleopatra.X509"
  DeleteRegValue SHCTX "Software\Classes\.pfx\OpenWithProgids" "gpg4win.AssocFile.kleopatra.X509"
  DeleteRegValue SHCTX "Software\Classes\.crt\OpenWithProgids" "gpg4win.AssocFile.kleopatra.X509"
  DeleteRegValue SHCTX "Software\Classes\.der\OpenWithProgids" "gpg4win.AssocFile.kleopatra.X509"
  DeleteRegValue SHCTX "Software\Classes\.mim\OpenWithProgids" "gpg4win.AssocFile.kleopatra.MIME"
