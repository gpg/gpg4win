...
!else
  ...
  Delete "$INSTDIR\share\icons\oxygen\32x32\status\*.png"
  Delete "$INSTDIR\share\icons\oxygen\32x32\places\*.png"
  Delete "$INSTDIR\share\icons\oxygen\32x32\mimetypes\*.png"
  Delete "$INSTDIR\share\icons\oxygen\32x32\emblems\*.png"
  Delete "$INSTDIR\share\icons\oxygen\32x32\devices\*.png"
  Delete "$INSTDIR\share\icons\oxygen\32x32\categories\*.png"
  Delete "$INSTDIR\share\icons\oxygen\32x32\apps\*.png"
  Delete "$INSTDIR\share\icons\oxygen\32x32\actions\*.png"
  
  Delete "$INSTDIR\share\icons\oxygen\48x48\status\*.png"
  Delete "$INSTDIR\share\icons\oxygen\48x48\places\*.png"
  Delete "$INSTDIR\share\icons\oxygen\48x48\mimetypes\*.png"
  Delete "$INSTDIR\share\icons\oxygen\48x48\emblems\*.png"
  Delete "$INSTDIR\share\icons\oxygen\48x48\devices\*.png"
  Delete "$INSTDIR\share\icons\oxygen\48x48\categories\*.png"
  Delete "$INSTDIR\share\icons\oxygen\48x48\apps\*.png"
  Delete "$INSTDIR\share\icons\oxygen\48x48\actions\*.png"
  ...
  Delete "$INSTDIR\share\icons\oxygen\128x128\status\*.png"
  Delete "$INSTDIR\share\icons\oxygen\128x128\places\*.png"
  Delete "$INSTDIR\share\icons\oxygen\128x128\mimetypes\*.png"
  Delete "$INSTDIR\share\icons\oxygen\128x128\emblems\*.png"
  Delete "$INSTDIR\share\icons\oxygen\128x128\devices\*.png"
  Delete "$INSTDIR\share\icons\oxygen\128x128\categories\*.png"
  Delete "$INSTDIR\share\icons\oxygen\128x128\apps\*.png"
  Delete "$INSTDIR\share\icons\oxygen\128x128\actions\*.png"

  Delete "$INSTDIR\share\icons\oxygen\256x256\status\*.png"
  Delete "$INSTDIR\share\icons\oxygen\256x256\places\*.png"
  Delete "$INSTDIR\share\icons\oxygen\256x256\mimetypes\*.png"
  Delete "$INSTDIR\share\icons\oxygen\256x256\emblems\*.png"
  Delete "$INSTDIR\share\icons\oxygen\256x256\devices\*.png"
  Delete "$INSTDIR\share\icons\oxygen\256x256\categories\*.png"
  Delete "$INSTDIR\share\icons\oxygen\256x256\apps\*.png"
  Delete "$INSTDIR\share\icons\oxygen\256x256\actions\*.png"
  ...
  RMDir "$INSTDIR\share\icons\oxygen\256x256\status"
  RMDir "$INSTDIR\share\icons\oxygen\256x256\places"
  RMDir "$INSTDIR\share\icons\oxygen\256x256\mimetypes"
  RMDir "$INSTDIR\share\icons\oxygen\256x256\emblems"
  ...
  RMDir "$INSTDIR\share\icons\oxygen\256x256\actions"
