...
# GPG4WIN_QTPKG([PKG],[DEPENDS],[IF-FOUND],[IF-NOT-FOUND])
# Set up the source package PKG.
# It is provided in gpg4win_val.
AC_DEFUN([GPG4WIN_QTPKG],
[
  AC_REQUIRE([GPG4WIN_INIT])
  _gpg4win_pkg=maybe
  AC_ARG_ENABLE([pkg-$1],
  ...
  AS_IF([test "$_gpg4win_pkg" != no],
        [GPG4WIN_FIND($1,,, $_gpg4win_pkg,
	 _gpg4win_qtpkg=$gpg4win_val
	 _gpg4win_version=$gpg4win_version)])

  # At this point, _gpg4win_qtpkg is no, or the actual package source file.

  # gpg4win_pkg_PKGNAME=FILENAME_OF_SOURCE
  gpg4win_pkg_[]m4_translit([$1],[-+],[__])[]=$_gpg4win_qtpkg
  AC_SUBST(gpg4win_pkg_[]m4_translit([$1],[-+],[__]))
...
# GPG4WIN_KF5PKG([PKG],[DEPENDS],[IF-FOUND],[IF-NOT-FOUND])
# Set up the source package PKG to be additionally built
# for the host provided as additional-gpgex-host
AC_DEFUN([GPG4WIN_KF5PKG],
[
  AC_REQUIRE([GPG4WIN_INIT])
  _gpg4win_pkg=maybe
  AC_ARG_ENABLE([pkg-$1],
  ...
  AS_IF([test "$_gpg4win_pkg" != no],
        [GPG4WIN_FIND($1,,, $_gpg4win_pkg,
        _gpg4win_kf5pkg=$gpg4win_val
        _gpg4win_version=$gpg4win_version)])

  # gpg4win_pkg_PKGNAME=FILENAME_OF_SOURCE
  gpg4win_pkg_[]m4_translit([$1],[-+],[__])[]=$_gpg4win_kf5pkg
  AC_SUBST(gpg4win_pkg_[]m4_translit([$1],[-+],[__]))
