...
% Document version:
\newcommand{\manualversion}{2.0.0.RC2}
\newcommand{\manualdate}{7. März 2006}
...
\item[Warum unterstützt GPGol keine PGP/MIME Signaturen?]
  ...
  Signaturen in einem Plugin zu prüfen.  Outlook verändert die
...
Programmen auf Gpg4Win umsteigen können.  Das Installprogramm erkennt
einige dieser Programme und warnt Sie in diesem Fall. 
