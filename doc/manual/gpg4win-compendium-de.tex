...
\section{GpgOL startet nicht mehr, wenn Gpg4win vorher auf einem anderen Laufwerk installiert war}
...
Dabei wird beim Start von Outlook das Plugin GpgOL nicht mehr
...
(gecachten) Plugin-Pfad zurücksetzen.
...
\section{Vertrauenswürdigkeit der Wurzel-Zertifikate durch Benutzer markieren}

Wurzel-Zertifikate können auch jeweils von den einzelnen Benutzern als
...
Wurzel-Zertifkats gefragt, ob Sie es nun als vertrauenswürdig einstufen wollen.
...
\W\chapter*{D Umstieg von anderen GnuPG Programmen}
\label{ch:migration}
...
Effekt: Die Komponente K in der Version X bleibt auf dem System verwaist
zurück.

Mögliche Lösung: 
Installer ruft den aktuellen Deinstaller für die Komponente K auf, falls
...
Komponenten zu entfernen.  Das bedeutet, dass der MSI installer in dem obigen
...
Verzeichnisse bzw. Registryschlüssel zurück:
...
\begin{itemize}
    ...
    \item Registryschlüssel:\\
        ...
        \textit{(Wird vom Gpg4win-2.0.0-Installer entfernt.)}\\
