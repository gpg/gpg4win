...
Ende dieses Kaptiels.} %TODO:Seitenzahl
\margin{\IncludeImage[width=1.5cm]{openpgp-icon}}

Im Abschnitt~\ref{publishPerEmail} haben Sie Adele Ihr
OpenPGP-Zertifikat -- Ihren öffentlichen Schlüssel -- geschickt.
...
\clearpage
%% Orginal page 32
\subsubsection{Nachricht mit Outlook und GpgOL entschlüsseln}
...
Kleopatra kennt alle Ihre eigenen Zertifikate und die Ihrer
...
Adele, die mit Ihrem OpenPGP-Zertifikat verschlüsselt wurde. Um die
...
einen Statusdialog, der Ihnen die Möglichkeit bietet mit \Button{Details einblenden}
weitere Informationen zur Überprüfung anzuzeigen:
...
Möchten Sie den Prüfdialog nach dem Lesen der Mail noch einmal manuell aufrufen, s
