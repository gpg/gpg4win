...
Starten brauchen dazu Outlook, Kleopatra und natürlich ein Zertifikat
...
Wählen Sie im Menü des geöffneten Nachrichtenfensters
\Menu{Extras$\rightarrow$GnuPG Protokoll$\rightarrow$PGP/MIME} aus.

Sofern Sie die Auswahl auf \textit{automatisch} lassen, haben Sie
...
Geben Sie nun an, dass Sie Ihre Nachricht verschlüsselt senden wollen:
Wählen Sie \Menu{Extras$\rightarrow$Nachrichten mit GnuPG
verschlüsseln}. Die Schaltfläche mit dem gelb/roten Icon in der
...
\end{center}
Um Ihre Nachricht doch unverschlüsselt zu
senden, deaktivieren Sie mit einem erneuten Klick die
Verschlüsselungsoption.

Klicken Sie nun auf \Button{Senden}.

\clearpage
Daraufhin öffnet sich ein Fenster mit den Zertifikaten, die Sie in
Ihrere Zertifikatsverwaltung haben. 
...
Klicken Sie auf Adeles Zertifikat, denn damit muss die Nachricht ja
...
verschlüsselt und Sie erhalten eine Meldung, die Ihnen dies
bestätigt.
