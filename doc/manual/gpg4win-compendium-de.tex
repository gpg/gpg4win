...
Ihr X.509-Zertifikat ist in dieser Signatur enthalten und kann von dem
...
Wurzelzertifikat --
Zertifizierungsstelle -- Ihr Zertifikat) oder nur Ihr Zertifikat in
...
Sagen Sie nun, dass Sie Ihre Nachricht verschlüsseln wollen. Klicken Sie 
dazu auf die GpgOL-Verschlüsseln-Schaltfläche in der Outlook-Symbolleiste oder
im Menü auf \Menu{Extras->Nachricht verschlüsseln}.

Klicken Sie schließlich auf \Button{Senden}.
...
Wählen Sie \Menu{Extras$\rightarrow$Nachricht verschlüsseln}.
