...
\clearpage
\section{Bekannte Fehlermeldungen und was man tun kann}

Dieser Abschnitt ist noch nicht ausformuliert.
Er wird auflisten welche bekannten Fehler es gibt
und was man dann tun muss um seine Aufgabe zu lösen.
...
Dies erfolgt über Systemsteuerung -> Verwaltung -> Komponentendienste
und dort über ,,Dienste (Lokal)'': In der Liste finden Sie ,,DirMngr'' -
...
Dieser Abschnitt ist noch nicht ausformuliert.
Er wird auflisten welche Dateien man wo auf dem Dateisystem
und welche Einstellungsparameter man wo in den Konfigurationsprogrammen findet.
...
Dieser Abschnitt ist noch nicht ausformuliert.
Er wird erklären wie man einem Fehlverhalten der
Gpg4win Programme auf die Spur kommt. Dazu gehört
vor allem die Information wie man Log-Dateien einschaltet,
wo man sie findet und wie man sie interpretiert und
für einen Fehlerbericht verwendet.
