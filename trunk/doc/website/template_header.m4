...
<html>
  <head>
    ...
    <meta name="keywords" content="Gpg4win, GnuPG, WinPT, GPA, GPGol, GPGee, Sylpheed, Sylpheed-Claws, E-Mail, Email, Windows, WinXP, XP, 2000, Win98, Win95, Win98SE, PGP, GPG, GnuPP, OpenPGP, Outlook, I18N(`EN', `Encryption, Secure') I18N(`DE', `Verschlüsselung, sicher, sichere, Sicherheit')">
